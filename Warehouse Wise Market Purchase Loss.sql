...
WHERE tss.CreatedOn> '2022-01-23 00:00 +06:00'
and tss.CreatedOn<= '2022-01-24 00:00 +06:00'
...
GROUP BY pv.Id,pv.Name,w.Id,w.Name,c.name,CAST(dbo.tobdt(tss.CreatedOn) as DATE),dbo.GetEnumName('CreationEventType',CreationEventType) ,de.Id,de.DesignationName
